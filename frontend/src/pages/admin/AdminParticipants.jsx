    ...
    <div className="bg-[#FAF6EE] min-h-full">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
        <div>
          ...
          <h2 className="text-3xl font-bold text-[#1C2541]">
        ...
        <div className="flex items-center gap-4">
          <div className="bg-white rounded-xl border border-[#1C2541]/10 px-4 py-2 shadow-sm">
            ...
            <p className="text-2xl font-bold text-[#1C2541]">
              {total}
            </p>
          </div>
          <ExportButtons
            ...
            {loading ? (
              ...
              participants.map((p) => (
                <tr key={p.id} className="border-b border-[#1C2541]/5 last:border-0 hover:bg-[#FAF6EE]">
                  ...
                  <td className="p-4 text-[#6B7785] font-mono text-sm">{p.phone_number || 'N/A'}</td>
                </tr>
              ))
            )}
          </tbody>
